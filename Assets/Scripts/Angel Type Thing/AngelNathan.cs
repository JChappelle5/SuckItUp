...
public class NewMonoBehaviourScript : MonoBehaviour
{
    ...
    void angelTriggerChance(int currFall){
        ...
        int totalFallChance = currFallChance + cumFallChance + timeChance; //sums the chance
        ...
        if (totalFallChance < randomNumGen){ //rolls for angel mechanic chance
            ...
            cumFallChance += (int) ((currFall * currFall) * 0.005);
            if(cumFallChance > 12){ //Caps the chance to 12
                cumFallChance = 12;
            }
        }
    }
